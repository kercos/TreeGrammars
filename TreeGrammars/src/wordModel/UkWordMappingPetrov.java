 ...
 */
public class UkWordMappingPetrov extends UkWordMapping {
	
	public static int unknownLevel = 5; //different modes for unknown words, 5 is english specific
	...
	public String getName() {
		return "Petrov_ukLevel_" + unknownLevel;
	}

	@Override
	protected void printParametersInfo() {
		System.out.println("Known word lowercase: " + knownWordsLower.size());
	}


	@Override
	public String getFeatureOfWord(String word, boolean firstWord, int trainingDevelop) {
		return getNewSignature(word, firstWord);
	}
