...
public class SpinnerNumberModelNew 
	extends AbstractSpinnerModel implements Serializable
{
     ...
     */
    public SpinnerNumberModelNew(Number value, Comparable minimum, Comparable maximum, Number stepSize) {
     ...
     *     <code>minimum &lt;= value &lt;= maximum</code>
     */
    public SpinnerNumberModelNew(int value, int minimum, int maximum, int stepSize) {
     ...
     *     <code>minimum &lt;= value &lt;= maximum</code>
     */
    public SpinnerNumberModelNew(double value, double minimum, double maximum, double stepSize) {
