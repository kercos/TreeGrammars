...
public class Reranker_EisnerCBackoff extends Reranker_ProbModelBackoff {
	
	private static boolean countEmptyDaughters = false;
	private static boolean printTables = false;
	
	
	// P(dist, w(d),t(d) | h, s, dir)
	public Reranker_EisnerCBackoff(File goldFile, File parsedFile, int nBest, 
	...
	public static String[][] fillBackoffTagsTable(TDNode h, TDNode s, TDNode d, String dir, int dist) {
		...
		//2: tag(daughter)
		//-----
		//3: parent (lexpostag, lex, postag, "*")
		//4: previous sister (lexpostag, lex, postag, "*")
		//5: direction (dir, "*")
	...
	public static void main1(String[] args) {
		...
		new Reranker_EisnerCBackoff(outputTestGold, parsedFile, nBest, 
	...
	public static void main(String args[]) {			
		...
		boolean[] skipEvents = new boolean[]{false, false, false};
		int[][] groupEventLevels = new int[][]{{1},{1},{1}};
