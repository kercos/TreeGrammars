...
public class RerankerCFGProb extends Reranker_ProbModel{
	...
	public RerankerCFGProb(File goldFile, File parsedFile, int nBest, 
		...
		this.SLP_children = SLP_children;
	...
	public static void main(String args[]) {			
		...
		int depType = 4; //"MST", "COLLINS97", "COLLINS99", "COLLINS99Arg", "COLLINS99Ter", "COLLINS99TerArg"
		...
		new RerankerCFGProb(outputTestGold, parsedFile, nBest, training, uk_limit, 
