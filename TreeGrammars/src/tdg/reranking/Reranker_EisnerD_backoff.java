...
public class Reranker_EisnerD_backoff extends Reranker_ProbModelBackoff {
	...
	public Reranker_EisnerD_backoff(File goldFile, File parsedFile, int nBest, 
	...
	public void updateCondFreqTables(TDNode thisNode) {
		...
		for(TDNode t : structure) {		
			...
			int previousChosenDaughterIndex = t.index;
			int previousDaughters = 0;
			int v = t.leftProle();			
			if (t.leftDaughters!=null) {				
				for(int li = t.leftProle()-1; li>=0; li--) {
					nextChosenDaughter = (li==0) ? null : t.leftDaughters[li-1];
					for(int l=0; l<previousChosenDaughterIndex;l++) {
	...
	public static void main1(String[] args) {
		...
		new Reranker_EisnerD_backoff(outputTestGold, parsedFile, nBest, training, uk_limit,  
	...
	public static void main(String args[]) {			
		...
		boolean[] skipEvents = new boolean[]{false};
		int[][] groupEventLevels = new int[][]{{1}};
		//int[][] groupEventLevels = new int[][]{{1,3,2,1}};
