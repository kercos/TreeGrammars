...
public class Reranker_EisnerCBackoff_extended extends Reranker_ProbModelBackoff {
	...
	public Reranker_EisnerCBackoff_extended(File goldFile, File parsedFile, int nBest, 
	...
	public static void main1(String[] args) {
		...
		new Reranker_EisnerCBackoff_extended(outputTestGold, parsedFile, nBest, 
