...
public class RerankerArgPresence extends Reranker_ProbModel {
	...
	public void updateCondFreqTables(TDNode t) {
		...
		int hasArgs = (t.countArgumentDaughters()>0) ? 1 : 0;
		String key =  parentTag + "_" + hasArgs;
	...
	public static void main(String args[]) {			
		...
		new RerankerArgPresence(outputTestGold, parsedFile, nBest, training, uk_limit, 
				SLP_sub_parent, limitTestSetToFirst, addEOS, markTerminalNodes).reranking();
	}
