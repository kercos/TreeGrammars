...
import tsg.corpora.Parc;
import tsg.corpora.Wsj;
import util.file.FileUtil;

public class Parc2HeadsDebug {
	...
	public static void buildIndexBinaryFile(File outputFile) {
		...
		for(TSNode t : parcGoldCorpus.treeBank) {
			indexesStructure.add(t.getHeadsBitSet()); 
		}
		FileUtil.toBinaryFile(outputFile, indexesStructure);
	}
	
	public static void assignHeads(File indexBinaryFIle, File sec23File, File outputFile) {
		Vector<BitSet> structure = (Vector<BitSet>)FileUtil.fromBinaryFile(indexBinaryFIle);
		ConstCorpus sec23Corpus = new ConstCorpus(sec23File, "sec23", false);
		sec23Corpus = sec23Corpus.returnIndexes(indexesSec23);
		sec23Corpus.removeTraces(Wsj.traceTag);
	...
	public static void run(String[] args) {
		...
		if (args.length!=2) {
			...
			System.err.println("Please use: java Parc2Heads <sec23File> <outputFile>");
			return;
		}
	...
	public static void main(String[] args) {
		File output = new File("HeadParc.mrg");
		File sec23File = new File(Wsj.WsjOriginalCleaned + "wsj-23.mrg");
		File headIndexFile = new File("HeadIndexBinaryFile");
		//buildIndexBinaryFile(headIndexFile);
		assignHeads(headIndexFile, sec23File, output);
	}
}
